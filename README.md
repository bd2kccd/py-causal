**Note 2023-02-26: This project uses an old version of [Tetrad](https://github.com/cmu-phil/tetrad) and a method of connecting Python to Java Javabridge, that's proven sometimes buggy and hard to install on some platforms, and so we are no longer recommending it. Please consider using [py-tetrad](https://github.com/cmu-phil/py-tetrad) instead. Py-tetrad uses [JPype](https://jpype.readthedocs.io/en/latest/) to bridge Python and Java, which has already shown itself to be much easier to install and use cross-platform. Also, it allows one to use the most recent version of Tetrad. We may after some time come back and try to re-implement this repository using JPype, as it has been used in the literture.**
